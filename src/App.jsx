...
const subsystemData = [
    ...
    members: [
      {name: 'Aarohi Gupta',
         ...
         {name: 'Madhur',
          ...
          linkedin: 'https://www.linkedin.com/in/madhur-likhmani-44620b337?utm_source=share_via&utm_content=profile&utm_medium=member_android',
          image: memberPhotos.wetLab.madhur,
       ...
       {name: 'Ranit S Sooraj',
        ...
        {name: 'Abhinav Gupta',
          role: 'Wet Lab Trainee',
          linkedin: 'https://www.linkedin.com/in/abhinav-gupta-16b57a373?utm_source=share_via&utm_content=profile&utm_medium=member_android',
          image: memberPhotos.wetLab.abhinav,
          imagePosition: 'center 50%',
            imageZoom: 1,
        },
         {name: 'Manish S',
  ...
  },
  {
    ...
    members: [
       {name: 'Arhan Khade',
          role: 'Dry Lab Lead',
          linkedin: 'https://www.linkedin.com/in/arhan-khade-414780322/',
    ...
    members: [
        ...
        {name: 'Angel Singhvi',
         ...
         {name: 'Yashika ',
          ...
          {name: 'Arnav Oza',
          role: 'iHP Associate',
          linkedin: 'https://www.linkedin.com/in/arnav-oza-301077349?utm_source=share_via&utm_content=profile&utm_medium=member_ios',
          image: memberPhotos.humanPracticesDesign.arnav,
          imagePosition: 'center 30%',
           imageZoom: 1,
        },
        {name: 'Tanish Jain',
        ...
        {name: 'Latisha Meena',
          ...
          image: memberPhotos.humanPracticesDesign.mitali,
          imagePosition: 'center 20%',
           imageZoom: 1.2,
        },
      ]
